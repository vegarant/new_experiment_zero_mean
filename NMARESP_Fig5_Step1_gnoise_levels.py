...
np.save(join(src_data,'NMARESP_noisy_input_gnoise_levels.npy'),noisy_input_gnoise_full)
np.save(join(src_data,'NMARESP_gnoise_levels.npy'),noise_gnoise_full)
np.save(join(src_data,'NMARESP_automap_rmse_gnoise_levels.npy'),rmse_gnoise_levels)
np.save(join(src_data,'NMARESP_automap_output_gnoise_levels.npy'),automap_output_full)
