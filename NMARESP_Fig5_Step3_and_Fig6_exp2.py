...
automap_gnoise_levels_rmse_vec = np.load(join(src_data,'NMARESP_automap_rmse_gnoise_levels_row2.npy'))

automap_gnoise_outputs = np.load(join(src_data,'NMARESP_automap_output_gnoise_levels_row2.npy'))

automap_gnoise_outputs = np.reshape(automap_gnoise_outputs,(automap_gnoise_outputs.shape[0],128,128))

lasso_gnoise_outputs = np.load(join(src_data,'NMARESP_lasso_gnoise_recons_row2.npy'))
...
plt.savefig('figure6a1_row2.pdf')
...
plt.savefig('figure6b1_row2.pdf')
