...
#filename3 = join(src_data,'HCP_mgh_1002_T2_subset_N_128.mat')
...
np.save(join(src_data,'NMARESP_noisy_input_gnoise_levels_row4.npy'),noisy_input_gnoise_full)
np.save(join(src_data,'NMARESP_gnoise_levels_row4.npy'),noise_gnoise_full)
np.save(join(src_data,'NMARESP_automap_rmse_gnoise_levels_row4.npy'),rmse_gnoise_levels)
np.save(join(src_data,'NMARESP_automap_output_gnoise_levels_row4.npy'),automap_output_full)
