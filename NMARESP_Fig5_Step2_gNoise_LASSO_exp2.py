...
noisy_input_array = np.load(join(src_data,'NMARESP_noisy_input_gnoise_levels_row2.npy'))
...
with tf.compat.v1.Session() as sess:
    ...
    np.save(join(src_data,'NMARESP_lasso_gnoise_recons_row2.npy'),LASSO_gnoise_recons)
