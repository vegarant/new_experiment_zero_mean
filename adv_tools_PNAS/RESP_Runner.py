import numpy as np;
from .RESP_adversarial_tools import pertub_SGA, l2_norm_of_tensor
...
class Runner:
    ...
    :param mask: Sampling mask used for Fourier sampling.
        ...
        self.max_r_over_x_norm = max_r_over_x_norm;
        self.la = la;
    ...
    def find_adversarial_perturbation(self, f, dQ, batch):
        ...
        if self.optimizer == 'SGA':
            rr, vv, backlog = pertub_SGA(f, dQ1, batch, self.max_itr, 
                                         ...
                                         max_r_over_x_norm=self.max_r_over_x_norm);
