...
from .RESP_Runner import Runner;
...
--------    ------------------ %03d: %s --------------------------
            ...
            la: %g, max_r_norm: %g, max_diff_norm: %g, max_r_over_x_norm, %g,
            max_itr: %d
            ws: %s, wsf: %g, ps: %s psf: %g
----                                                             ----
""" % (
count, network_name, self.optimizer, self.momentum, self.learning_rate,
self.smoothing_eps, self.la, self.max_r_norm, self.max_diff_norm, self.max_r_over_x_norm, self.max_itr,
