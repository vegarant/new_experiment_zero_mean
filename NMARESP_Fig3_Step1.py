...
raw_f, raw_df = compile_network(sess, batch_size,fname_weights='CS_Poisson_For_Vegard.h5');
...
np.save(join(src_data,'NMARESP_orig_automap_advpert_fxr_array.npy'),fxr_array)
