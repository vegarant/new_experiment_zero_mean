...
# output_array = np.load('output_array_10k.npy')

filename_out = join(src_data,'test_x_hcpt2wnz_LS2_poisson_notrunc_offset_v3_5_128.mat')
output_array = mat73.loadmat(filename_out);
output_array = np.transpose(output_array['test_x'])
...
np.save('NMARESP_global_ratio.npy',ratio_gb)
